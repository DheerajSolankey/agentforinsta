...
export function openHelp() {
  ...
  const glossary = [
    ...
    ['Looks', 'One-click color grades (B&W, Vintage, Teal, Golden…).'],
    ['Motion', 'One-click camera moves (push-in, punch, Ken Burns).'],
    ['Text FX', 'Entrance animations for titles (fade, pop, slide, bounce).'],
    ...
    ['Clip Tools', 'Edit the selected clip: size, color, speed, fades.'],
    ['Keyframes', 'Animate a value over time (size, position, volume…).'],
